"""
Django settings for Hade project.
...
SECRET_KEY = 'django-insecure-jo49jmapgappqnjhb*d+krrbd)7#a_g@@-*91neuk@om1d5ng*'
...
ROOT_URLCONF = 'Hade.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'src/public/templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
